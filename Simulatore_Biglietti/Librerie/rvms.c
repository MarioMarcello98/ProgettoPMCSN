 ...
 */
double idfTruncatedNormal(double media, double deviazioneS, double lowerBound, double UpperBound, double random){
   double a = cdfNormal(media, deviazioneS, lowerBound-1);
   double b = 1.0-cdfNormal(media, deviazioneS, UpperBound);
   double u = idfUniform(a, 1.0-b, random);
   return idfNormal(media, deviazioneS, u);
}